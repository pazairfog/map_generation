...
export function choose(list, exponent) {
  exponent = exponent || 1;
...
export function spell(lang, syll) {
...
export function makeSyllable(lang) {
  while (true) {
    var syll = "";
...
export function getMorpheme(lang, key) {
  if (lang.nomorph) {
...
export function makeBasicLanguage() {
  return {
    phonemes: {
      C: "ptkmnls",
      V: "aeiou",
